...
public class SuperTextMeshEditor : Editor{
	override public void OnInspectorGUI(){
		...
		SerializedProperty multiMaterialUI = serializedObject.FindProperty("multiMaterialUI");
		...
		//Draw it!
			...
			if(stm.showAppearanceFoldout){
				...
				if(stm.textMat != null){
					...
					if(stm.uiMode){
						EditorGUILayout.PropertyField(multiMaterialUI);
					}
				}
			}
...
public class SuperTextMesh : MonoBehaviour { //MaskableGraphic... rip
	...
	[Tooltip("If true, enables UI text to have more than one material. Disabled by default because this might cause a crash on some systems.")]
	public bool multiMaterialUI = false;
